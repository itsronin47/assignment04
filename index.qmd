...
#I am making a change to my code, Hi Aaron! How about them Pacer's huh
```
\newpage
...
Minneapolis, MN: IPUMS, 2024. https://doi.org/10.18128/D030.V12.0"
  ...
  xlab("Score") +
  ylab("Count") +
  annotate("text", x = 5, y = 150, label = "December 2022-24", color = "red", size = 5)
...
## Stretch Assignment
When I try to git add my data, I get this message: 
Ronins-MacBook-Air:assignment04 ronin$ git add data/
